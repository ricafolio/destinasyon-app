  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between w-full mt-2">
        ...
        <button className="rounded-lg px-8 py-2 mt-2 sm:ml-2 sm:mt-0 text-lg sm:text-xl h-full transition-colors duration-150 focus:outline-6  disabled:cursor-wait focus:outline-amber-500 bg-amber-400 text-black hover:bg-amber-500 active:bg-amber-400 focus:bg-amber-500" onClick={onSubmitBtnClick} disabled={isFetching}>
          Get destinations
        </button>
      </div>
    </div>
